export const locations = [
    {
      ...
      image: "/locations/iltharion.png",

      description:
        "As the home of the Elves, this city is a sprawling metropolis of Elvish culture. The residents of Iltharion rarely leave the city as there is a general distaste of the outside world within the walls. Iltharion streets are lined with hanging baskets and flowering vines, with street performers singing gently and playing flute in the courtyards. There are a surprising number of fountains throughout the city and there are many small parks, where young Elves play among themselves. The closer you get to the centre of the city, the more affluent the locale becomes, though even the outermost reaches are far more beautiful than most other cities in the Aeoth Plateau.",
      lore: `
        Whilst the city came into being too long ago for the history books to remember much, it is known that the Lady Ith founded the great city of Iltharion. This city rose to power exceptionally fast and within a century, had become a powerhouse for commerce and artistic wonder.
      ...
      The princess is not of Floestra’s blood, but it is still known that the queen treats her as her own. She has curly brown hair and is notably not an elf. She is conventionally attractive and appears to be mid-thirties, though she has been alive far longer. She is fair and kind and can often be found in the poorer Tangle district among peasants and tradespeople. 


      Lord and Lady Marren

      Lord Marren is an elderly Elf with dark skin and soft features, seeming to always have a wide grin. His wife, the Lady Marren is also elderly, with dark skin, though she has hard features and seems to have a resting stern face. These two are the main figures in Queen Floestra’s council and are exceptionally wealthy and powerful tradespeople all through the Aeoth Plateau. Between them, they not only run one of the biggest trade routes in the land, but they also head the Elvish parliament. Queen Floestra considers them dear friends and whilst a little snobby, they are liked dearly among the people.
  ...
  
    {
      ...
      Selentheia functions as a Monarchy, with an elected council of the finest entertainers serving the throne. The city is primarily populated by Halflings and Kendra, though Elves, Dwarves, Rakin and Inukin are similarly common. There is a joke in the land that roughly translates to “If one is over 5 feet tall, they are either an Elf, or they are leaving”, though King Yourn denies any sort of cultural racism in his land.
      ...
      Though Hettie may not formally be the Queen, as Yourn’s second wife, she is nonetheless adored by her subjects and her husband. She met the king during an orchestral performance, and he was instantly captivated by her flute playing. She is an NG Halfling in her fourties with long brown hair coming down to her thighs. She is almost always seen wearing the traditional bright colours of the nation, with ornate robes and gemstone earrings.


      The Glorious St Derek
      
      The glorious St Derek is the stage name of Derek Bigsby, one of the two lead Orchestrators of Selentheia. He was elected to this seat at the head of King Yourn’s council due to his reputation for leading magical carnivals, as well as his track record of excellent musical compositions. He is a CG Kendra male with big eyes and a bigger heart. He wears his emotions on his sleeve and is often seen crying, shouting, laughing and running through the streets. He dyes his shoulder length hair new colours every few days depending on his mood and is starting to show his age, with a salt and pepper coloured beard and slight wrinkles around his eyes. 
...

    {
      ...
      ruler:`
      High Astrologer Kaleph

      Kaleph rose to prominence as a child prodigy of the school of divination. He was the first to discover the effects of The Stagnation on the heavens and alongside his husband, High Astrologer Abacus, he leads The Observatory’s council. Kaleph is a LG gnome with thin grey hair, a long nose that often sports a monocle, black robes with golden trim and a thin, spindly build. Kaleph is respected among the people, adored by scholars and feared by his students! His reputation for long, dull lessons and mostly impossible homework set him apart from most of the Hall of Scholars faculty, and though he does not lead the school, his position at the head of the city council grants him immense sway over the running of the college. Kaleph met Abacus when they were both young students together. What started off as a bitter rivalry turned into an acceptance of each other and later blossomed into love - even the King and Queen Breezechant of the Coral Courts are said to admire their romance.
      ...
      As the head of the Hall of Scholars, Principal Hockchock is permanently busy. She is known for being compassionate, with a devilish intellect. Hockchock is a N Gobboc woman, with bright green feathers, resembling an oddly grand hen. She stands just 4 feet tall and is often seen wearing her purple professor robes. As the Principal of The Observatory’s greatest college, her days are filled with administrative tasks, though she often states how much she wishes to return to teaching full time. Unfortunately for her though, she is respected and liked and has been under a lot of pressure not to resign, due to how great of a principal she is. 


      Esodrin

      Esodrin is a prominent educator in the Hall of Scholars, known for his mastery of many schools of magic. His passion lies in divination magic, though he admits that he is more skilled in the arts of evocation and abjuration. Esodrin is a NG Human male, with long white hair, a long white beard and more wrinkles that any person should have. Esodrin is known for being a recluse, he has travelled far and wide across the Aeoth Plateau and none truly know how old he is, or where he came from.
    ...
    {
      id: 10,
      name: "The Coral Courts",
      type: "city",

      image: "/locations/coralcourts.png",

      description:
        "The Coral Courts stretch over miles of seabed as a home to the Merfolk, Cnidarians, Fishfolk and the occasional Tortle. The area is mostly kept natural, with clear waters and hundreds of acres of below-surface farms. Most of the population live through the Rainbow Corals or the Kelp Jungles in bubble-pods or sea-caves. The Swash Castle sits at the centre of the land and is home to the monarchy. Residents here are often found tending their magical fish livestock or mingling at the trading hub, which acts as a local cultural centrepiece. The sight of starlight bouncing off the surface is something to behold as manufactured bioluminescence brings the dark water to colourful light.",
      lore:`
      The Rainbow Corals lie to the south of the Coral Courts and boast one of the most impressive nightlife scenes in the whole Aeoth Plateau. The dancing lights of bioluminescent algae glisten under the moon; with the legendary dancing performances of the Cnidarians, the district turns into a living disco. Legends tell of an ancient sea dragon that would weave through the Rainbow Coral district, though it has not been seen since over a millennia ago. High astrologers of The Observatory suggest that it may have simply been an underwater mirage of sorts, though locals still believe that Eauthis the Diffused will return one day.
      ...
      ruler:`
      Queen Mohlin Breezechant
      
      From a young age the princess was taught a strict moral compass by her father, the late King Scalius. Lessons in manners and etiquette punctuated her childhood, though she was known to sneak out of the castle to go to the trading hub, where she could spend time with the rich and poor alike. It was here that she met her future husband, Gahred and fell in love with his charm. Mohlin has regaled the story countless times, of her husband mistaking her for a commoner when they first met. With King Scalius’ passing, Mohlin rushed to take Gahred to get married before her coronation. Nowadays she spends most of her time in the courts tending to her people. Queen Mohlin is a NG Cnidarian with long gold and pink tentacles, and large beady black eyes. She is stunningly beautiful, with a tall, slender build and flowy white robes, that dance gracefully in the ocean currents. 
      ...
      ImportantPeople:`
      Aster, High Cleric of the Coral

      High Cleric Aster is a N Merman male, with a muscular build, dark skin and an iridescent tail. He has a shaggy black beard, a bald head and appears to be in his late fourties. There are mixed opinions of Aster through the land. Those worshipping Aqui, God of the Sea often commend him for his devotion, though non-believers criticise him for his insistence for spreading the faith onto land, away from their homeland. Regardless of public opinion, he is a talented user of divine magic and has been responsible for driving off sea beasts many times. 


      Mo Hardshell

      Mo is a NG Tortle with a glistening shell adorned with golden jewellery. She is responsible for any dealings with the outside world, primarily the Festival of Fish, where the rockpools of Winct are filled with drinking, dancing and carnival games, in the name of Aqui, God of the Sea. Mo is generally seen running around the Swash Castle, and its surrounding grounds, too busy to talk to visitors. With the King and Queen being so happy-go-lucky, she often overcompensates by overworking herself. Despite her permanent rushed intensity, she is still liked among the people as she is exceptionally good at her job.
...

    {
      ...
      Wirth Hornsby is a CN male Drow, leading his peoples’ culinary district. He stands 7 feet tall, with pale purple skin, thick muscles and an appearance of someone in their early thirties. He is conventionally attractive, though his sour personality makes him severely dislikeable. He is often seen with either a meat tenderiser or a butcher’s knife – good for killing, good for food preparation. Wirth is impressively violent, though he is known to have a soft spot for the orphans of the Diamond Enclave (which he would never openly admit). Wirth spends his days patrolling the Drow stalls in the markets with a scowl, and his nights working tirelessly in his restaurant: The Purple Bistro. Wirth has an open rivalry with Rheagorn, the head of the Golynn culinary district, though both seem to respect each other too much to encroach on the others’ territory.


      Rheagorn Marrowbutcher

      Rheagorn leads the Golynn culinary district as a 6-foot-tall N brick wall. His tough brown scales are burnt from hot oil accidents, and he wears a black apron and chefs’ hat at all times. He spends his days sleeping, and his nights working in the Pango Kitchen, a restaurant famed for its fruit and vegetable arrangements. Rheagorn appears, at first glance, to be incredibly stupid. He seems to lack conversational skills and has a painfully small vocabulary, but for what he lacks in charisma, he makes up for in brutishness and culinary excellence. Rheagorn is suspected to be the chairman of the 5 Star Pirates, an organisation prowling the seas for unsuspecting merchants and making up a sizeable portion of the city’s imports. Of course, he would never admit to such crimes.
...

    {
      ...
      lore:`
      Detheneer made its name as a warlord state, ruled by dark mages and evil powers of an age only remembered by the history books. With The Stagnation, Detheneer was hit harder than most. The land of dark forces became a city of apathy, lost without motivation. The ruler at the time, Salvador Greystaff, had ruled for many years, growing Orc armies and attacking other nations. With the wave of The Stagnation though, war ceased to matter to him; and what is an evil lord without evil intent? It didn’t take long for Greystaff to be ousted from power by the Orcs, who had recently discovered that they didn’t need to serve a dark lord and could instead exercise their free will. The Orcs grew tired of the land and its vile history though and migrated to find a new homeland, settling eventually with their kin in Hutton. Detheneer grew afterwards as a shadow of its former strength, ruled by the lineage of the Depresne family.
      ...
      ImportantPeople: `
      High Advisor Aren, of house Ironhead
      
      Aren serves as the right-hand-woman to Marshal Depresne. She is known for being extremely militaristic, wearing her army uniform in public at all times and walking with a rigid march. She is a LN female Dwarf, with straight black hair, tied up in a knot. She has a resting scowl on her face, though she will treat all except prisoners with unwavering dignity. Her reputation has been built on strict control, ordering the city guard to keep a constant eye upon residents with regular raids through taverns and rigorous document-checking at the city borders. Unfortunately for her though, this is no longer her job – Colonel Latimer took over charge of the city guards recently when Aren rose to the position of High Advisor. This has understandably led to a lot of conflict between the two, though both are disciplined enough to not let it affect their duties. Aren is rarely seen in public, though it is known that the military in Detheneer respect her more than Colonel Latimer and there are many rumours of secret guard-only-taverns which she will frequent.
...

    {
      ...
      ruler:
        "The Five Seats of Myconia",
      
      ImportantPeople: `
      Theris, of the Seat of Holy

      Theris is a LG Myconoid in the body of an Elf. She has long blonde hair and red mushrooms growing from an unusually non-decomposed face. She is known in the city for being a symbol of unwavering virtue, leaving many to respect her, but many to dislike her high-and-mighty attitude. Theris rarely leaves the confines of the Temple of the Mother, though she does make the occasional public appearance preaching ceremonies.


      Mansa, of the Seat of Tendril

      Mansa is a CN Myconoid in the body of a hill Dwarf. The Dwarf host’s body has decomposed now to the point that it is barely more than skin hanging to greyed bone. No one knows their gender or background, though judging by their position and the quality of their work, it is assumed that they must have been important in a past life. Mansa prefers to live among the people of Myconia and is often seen in the trading hub, mingling with travellers. 


      Heritude, of the Seat of Individual

      Heritude is a NG Myconoid in the body of a Halfling. She has thin brown mushrooms protruding from her arms and wispy brown hair. She is conventionally attractive, though physical appearances often go unnoticed by the Myconoids. Heritude spends most of her time travelling through the Aeoth Plateau, visiting monasteries and Myconoid settlements to check on their wellbeing. Heritude is known to be a fierce warrior and is rumoured to have been a great warlord in ages gone.


      Xeres, of the Seat of Searching

      Xeres is a CN Myconoid in the body of a Golynn. He has a large orange mushroom for a head and small orange mushrooms growing from between his scales. He is known to be mischievous, though deeply faithful. He is also known as a great intellect, being one of the few Myconoids to have studies at the Hall of Scholars in The Observatory. Xeres is often found wandering through the mushroom forests surrounding Myconia, deep in thought. Many believe that he should have been elected for the Seat of Holy, though he insists that Theris does the job very well and he is happy with his current position. 
...

    {
      ...
      image: "/locations/melxon.png",

      description:
        "Melxon is the city of Goblins. This city is widely revered for its craftsmanship and has given Goblinfolk a good reputation across the Aeoth Plateau for the quality and affordable prices they offer. Melxon smiths have introduced new methods for glassblowing and metallurgy, crafting exquisite armour and weaponry, ornate stained-glass windows and durable homeware. Melxon labourers are often found through the lands, working as contractors for the wealthy, as they are cheap and fast. Residents of this city are well educated due to the prevalence of vocational schools, teaching metalworking, glass blowing and engineering skills. The city of Melxon is not officially a pacifist nation, but they have consistently refused to donate weaponry to other nations during times of war.",
      lore:
        "",

      ruler:`
      Grand Craftmaster Breggart
      
      The ruler of Melxon, Grand Craftmaster Breggart is a LN Goblin male, with deep red skin and a bald, sunburnt head. His long, droopy ears have burns on them from his job working with glass and though he is technically king, he prefers working his craft to actually ruling. That being said though, Breggart is no softie. He is well spoken but is always down for a “friendly” scrap. He once bit off a councilmember’s ear during a disagreement, but this behaviour is not too uncommon among goblins so most don’t see him as violent.
...

    {
      ...
      image: "/locations/adarkark.png",

      description:
        "Adark Kark is the city of Trolls. This vast metropolis is one of the few cities to rival the size of Iltharion, though due to the size difference between elves and trolls, much fewer buildings reside here than in Iltharion. The troll living here are well known for their woodworking capabilities. Though the western Badlands are not home to any jungles or forests, trees can still be found to the north and Troll loggers venture into the dunes each day to battle the weather, sandworms and each other to bring back usable timber. The woodworking skills of the trolls may lack the grace of Elvish woodwork, but they make up for it in sturdiness. Adar Karken boats are almost unsinkable, and it is said that a man carrying a Karken shield into battle will never find it pierced by an arrow.",
      lore:
        "",

      ruler:`
      His Wrinkliness, Hj of Adar Kark
      
      Hj of Kark is a feared ruler, all throughout the land of Aeoth. Though he is a gentle pacifist, it is known that almost no one is able to craft a trade deal as well as him. It is said that Queen Floestra of Iltharion once sent an envoy to Adar Kark for a royal ship and they returned with a fleet of 100 and more tables than a nation could need in a century. Lord Atris of Sumnersburg even described Hj once as “the only person to ever sell me my own carriage”. Hj stands at 9 feet tall and is exceptionally muscular with deep grey skin, a thick black beard and Māori-inspired tattoos. He speaks slowly and does not hold a good vocabulary, but what he lacks in eloquence, he makes up for in charisma.
...

    {
      ...
      image: "/locations/hutton.png",

      description:
        "Hutton is the land of the Orcs. No one truly knows how big this city is as it delves deep into the side of the Grey Mountains. This land is known for its rich mining colonies and abundant natural gems, ores and magical artifacts. Some say the mountain mines lead into the underworld, though none have ever verifiably confirmed the truth of this claim. From a young age, Orcs growing up in this land are taught the importance of wealth, almost to the point of obsession. Despite this, the Orcs of Hutton tend not to hoard their gold, instead preferring to trade ore for gold and gold then for better mining equipment, in the hopes of finding the “Hut-Hut Gem”, a mythical artifact of incredible power that their forefathers once searched for. None remember now why this artifact was so important, but the search continues, nonetheless.",
      lore:
        "",

      ruler:`
      The Marquess Mulchch
      
      Mulchch is widely disliked for her micromanaging attitude to working the mines. Her great-great-great-great-great-great-great grandmother Gurghgh fought tooth and nail against the mountain Wargs for these mountains and now that she is in power, she will stop at nothing to find the “Hut-Hut Gem”. The Marquess Mulchch is conventionally extremely unattractive to most non-Orcs, though to Orcs, she is a figure of divine beauty. She stands at 7 feet tall, with matted black hair and a scarred, greyish face. She has long silver hoop earrings and more piercings that it would be polite to count. She is polite to outsiders but will refuse to back down from any disagreements, even if she knows that she is in the wrong.
